...
| **Qwen3-Coder-Next (Q4_K_M)** | 19.8 GB | 16,384 | 76 / 84 | 42.5 tok/s (ROCm) | 0 / 3 Fail | Rejected (failed tool calls) |
| **Qwen3.6-27B (Q6_K, dense)** | 24.4 GB | 16,384 | 77 / 84 | 41.0 tok/s (ROCm) | 3 / 3 Pass | 64GB host option (dense non-coder) |
